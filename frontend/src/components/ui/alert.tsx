  ...
  'relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground',
  {
    variants: {
      variant: {
        ...
        success: 'bg-success-50 border-success-200 text-success-800 [&>svg]:text-success-600',
...
export const InlineAlert: React.FC<AlertProps> = ({ className, size = 'sm', ...props }) => (
  <Alert
    {...props}
    size={size}
    className={cn('border-l-4 border-t-0 border-r-0 border-b-0 rounded-none pl-3', className)}
  />
);
