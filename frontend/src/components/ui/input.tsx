...
const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const paddingRight = (rightIcon || showPasswordToggle) 
    ...
    return (
      <div className={cn('w-full', containerClassName)}>
        ...
        <div className="relative">
          {/* Left icon */}
          {leftIcon && (
            <IconWrapper position="left" size={size || 'md'}>
              {leftIcon}
            </IconWrapper>
          )}
          ...
          {(rightIcon || showPasswordToggle) && (
            <IconWrapper position="right" size={size || 'md'}>
              {showPasswordToggle ? (
                <button
                  type="button"
