...
// DSWD Staff Dashboard component
export const DSWDStaffDashboard: React.FC<DSWDStaffDashboardProps> = ({
  user,
}) => {
  return (
              ...
              <div className='flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer'>
                ...
                <div className='ml-3'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Oversee and configure social programs
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href='/beneficiaries/oversight'>
              <div className='flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer'>
                ...
                <div className='ml-3'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Monitor beneficiary status and compliance
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href='/analytics/reports'>
              <div className='flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer'>
                ...
                <div className='ml-3'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Create program performance reports
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href='/policy/implementation'>
              <div className='flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer'>
                ...
                <div className='ml-3'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Track policy compliance and updates
                  </p>
                </div>
              </div>
            </Link>
          ...
          <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-gray-900'>
                Updated 4Ps eligibility criteria
              </p>
              <p className='text-xs text-gray-500'>
                Policy implementation completed - 2 hours ago
              </p>
            </div>
          </div>
          <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-gray-900'>
                Generated quarterly beneficiary report
              </p>
              <p className='text-xs text-gray-500'>
                Report distributed to regional offices - 4 hours ago
              </p>
            </div>
          </div>
          <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-gray-900'>
                Reviewed program compliance audit
              </p>
              <p className='text-xs text-gray-500'>
                3 regions require follow-up actions - 1 day ago
              </p>
            </div>
          </div>
          <div className='flex items-center space-x-3 p-3 bg-gray-50 rounded-lg'>
            ...
            <div className='flex-1'>
              <p className='text-sm font-medium text-gray-900'>
                Approved new program budget allocation
              </p>
              <p className='text-xs text-gray-500'>
                ₱2.4B allocated for disaster response programs - 2 days ago
              </p>
            </div>
          </div>
        </div>
