...
// LGU Staff Dashboard component
export const LGUStaffDashboard: React.FC<LGUStaffDashboardProps> = ({ user }) => {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Link href="/citizens/registrations">
              <div className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-600">Process new citizen registrations</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/applications">
              <div className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-600">Review benefit applications</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/reports">
              <div className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:shadow-md transition-all duration-200 cursor-pointer">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-600">Create statistical reports</p>
                </div>
              </div>
            </Link>
          </div>
        ...
        <Card className="p-6">
          ...
          <div className="mt-4 text-center">
            <Link href="/tasks" className="text-sm text-primary-600 hover:text-primary-500 font-medium">
              View all tasks
            </Link>
          </div>
        </Card>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Approved 3 benefit applications</p>
          ...
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Verified 5 citizen profiles</p>
          ...
          <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">Generated monthly statistics report</p>
