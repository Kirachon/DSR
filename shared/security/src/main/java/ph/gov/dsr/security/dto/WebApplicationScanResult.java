...
/**
 * DTO for web application scan results
 * 
...
@NoArgsConstructor
@AllArgsConstructor
public class WebApplicationScanResult {

    private String scanId;
    private String targetUrl;
    private SpiderScanResult spiderResult;
    private ActiveScanResult activeScanResult;
    private List<WebVulnerability> vulnerabilities;
    ...
    public long getCriticalVulnerabilities() {
        return vulnerabilities != null ? 
            vulnerabilities.stream().filter(WebVulnerability::isCritical).count() : 0;
    }
