...
/**
 * JWT Configuration Properties for Data Management Service
...
public class JwtProperties {
    ...
    private String issuer = "dsr-data-management-service";
    ...
    public JwtProperties(String secret, Long expiration, Long refreshExpiration, String issuer, String audience) {
        this.secret = secret;
